...
insert into korisnik (ime, prezime, email, username, password, grad, drzava, jmbg, adresa, telefon, datum_rodjenja, uloga, aktivan, aktiviran) values ('Petar', 'Kocic', 'petar.k@gmail.com','peka', 'peka', 'Beograd', 'Srbija', '1254784106521', 'Njegoseva 38', 114587698, '1973-3-3', 4, TRUE, TRUE);
insert into korisnik (ime, prezime, email, username, password, grad, drzava, jmbg, adresa, telefon, datum_rodjenja, uloga, aktivan, aktiviran) values ('Milan', 'Kokic', 'milan.k@gmail.com','mika', 'mika', 'Beograd', 'Srbija', '6325987451036', 'Njegoseva 38', 115698520, '1978-4-15', 4, TRUE, TRUE);
insert into korisnik (ime, prezime, email, username, password, grad, drzava, jmbg, adresa, telefon, datum_rodjenja, uloga, aktivan, aktiviran) values ('Arsenije', 'Nikolic', 'arsa.n@gmail.com','arsa', 'arsa', 'Beograd', 'Srbija', '1405632987450', 'Njegoseva 38', 114521063, '1982-4-15', 4, TRUE, TRUE);
insert into korisnik (ime, prezime, email, username, password, grad, drzava, jmbg, adresa, telefon, datum_rodjenja, uloga, aktivan, aktiviran) values ('Kristina', 'Obradovic', 'kika.o@gmail.com','kris', 'kris', 'Beograd', 'Srbija', '9632510478951', 'Njegoseva 38', 114785410, '1971-4-15', 4, TRUE, TRUE);
insert into korisnik (ime, prezime, email, username, password, grad, drzava, jmbg, adresa, telefon, datum_rodjenja, uloga, aktivan, aktiviran) values ('Milica', 'Barovic', 'milica.b@gmail.com','mica', 'mica', 'Beograd', 'Srbija', '0241578496520', 'Njegoseva 38', 1452638, '1980-5-15', 4, TRUE, TRUE);
insert into korisnik (ime, prezime, email, username, password, grad, drzava, jmbg, adresa, telefon, datum_rodjenja, uloga, aktivan, aktiviran) values ('Lucija', 'Gacanovic', 'lucija.g@gmail.com','lucija', 'lucija', 'Beograd', 'Srbija', '6352147895410', 'Njegoseva 38', 114525746, '1972-8-7', 4, TRUE, TRUE);
...
insert into pacijent (id_korisnik, visina, tezina, dioptrija, klinika_id) values (10, 174, 88, 0.5, 1);
insert into pacijent (id_korisnik, visina, tezina, dioptrija, klinika_id) values (11, 174, 88, 0.5, 1);
insert into pacijent (id_korisnik, visina, tezina, dioptrija, klinika_id) values (12, 174, 88, 0.5, 1);
insert into pacijent (id_korisnik, visina, tezina, dioptrija, klinika_id) values (13, 174, 88, 0.5, 1);
insert into pacijent (id_korisnik, visina, tezina, dioptrija, klinika_id) values (14, 174, 88, 0.5, 1);
...
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2029-12-1 9:00:00', true, 1, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2029-12-1  10:00:00', false, 1, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2029-12-1  11:30:00', true, 1, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2029-12-1  15:00:00', false, 2, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2029-12-1  16:00:00', false, 2, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2029-12-1  17:00:00', true, 2, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2029-12-1  15:00:00', true, 3, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2029-12-1  16:00:00', true, 3, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2029-12-1  17:00:00', true, 3, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2022-01-25 17:00:00', true, 3, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2022-01-25 17:00:00', true, 5, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2022-01-25 17:00:00', true, 2, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2022-01-25 18:00:00', true, 3, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2022-02-25 21:00:00', true, 3, 0, 0);
insert into termin(datum, slobodan, sala_id, trajanje, cena) values ('2022-02-25 21:00:00', true, 3, 0, 0);
...
insert into pregled (naziv, anamneza, datumivreme_pregleda, status, tip_pregleda, cena, doktor_id, pacijent_id, sala_id) values ('', '', '2020-02-02 16:00:00', 0, '', 50, 1, 2, 1);
insert into pregled (naziv, anamneza, datumivreme_pregleda, status, tip_pregleda, cena, doktor_id, pacijent_id, sala_id) values ('', '', '2020-02-02 17:00:00', 0, '', 50, 1, 3, 1);
insert into pregled (naziv, anamneza, datumivreme_pregleda, status, tip_pregleda, cena, doktor_id, pacijent_id, sala_id) values ('', '', '2020-02-02 18:00:00', 0, '', 50, 1, 3, 1);
insert into pregled (naziv, anamneza, datumivreme_pregleda, status, tip_pregleda, cena, doktor_id, pacijent_id, sala_id) values ('', '', '2020-02-02 19:00:00', 0, '', 50, 1, 1, 1);
insert into pregledi_dijagnoze(pregled_id, dijagnoza_id) values(1, 2);

insert into operacija(pacijent_id, status, datumivreme_operacije, trajanje) values(1, 0, '2022-01-25 17:00', 0);
insert into operacija(pacijent_id, status, datumivreme_operacije, trajanje) values(2, 0, '2022-01-25 17:00', 0);
insert into operacija(pacijent_id, status, datumivreme_operacije, trajanje) values(2, 0, '2022-02-25 21:00', 0);
insert into operacija(pacijent_id, status, datumivreme_operacije, trajanje) values(1, 0, '2022-02-25 20:00', 0);
insert into operacija(pacijent_id, status, datumivreme_operacije, trajanje) values(1, 1, '2022-01-10 18:00', 0);

insert into odsustvo (korisnik_id, vrsta_odsustva, pocetak_odsustva, zavrsetak_odsustva, odobren) values (9, 0, '2022-12-25', '2020-01-07', TRUE);
insert into odsustvo (korisnik_id, vrsta_odsustva, pocetak_odsustva, zavrsetak_odsustva, odobren) values (9, 1, '2022-01-25', '2020-01-28', TRUE);
insert into odsustvo (korisnik_id, vrsta_odsustva, pocetak_odsustva, zavrsetak_odsustva, odobren) values (9, 1, '2022-02-25', '2020-02-28', FALSE);

insert into pregled(pacijent_id, status, datumivreme_pregleda, cena, sala_id) values(1, 0, '2022-01-25 17:00', 500, 1);
insert into pregled(pacijent_id, status, datumivreme_pregleda, cena, sala_id) values(2, 0, '2022-01-25 17:00', 500, 1);
insert into pregled(pacijent_id, status, datumivreme_pregleda, cena, sala_id) values(2, 0, '2022-02-25 21:00', 500, 1);
insert into pregled(pacijent_id, status, datumivreme_pregleda, cena, sala_id) values(1, 0, '2022-02-25 20:00', 500, 1);
insert into pregled(pacijent_id, status, datumivreme_pregleda, cena, sala_id) values(1, 1, '2022-10-01 18:00', 500, 1);

insert into usluga(naziv, opis, cena, klinika_id) values ('Pregled','Obican pregled','2000',1);

insert into odsustvo (korisnik_id, vrsta_odsustva, pocetak_odsustva, zavrsetak_odsustva, odobren) values (5, 1, '2022-01-25', '2020-01-28', TRUE);
insert into odsustvo (korisnik_id, vrsta_odsustva, pocetak_odsustva, zavrsetak_odsustva, odobren) values (5, 1, '2022-02-25', '2020-02-28', FALSE);
