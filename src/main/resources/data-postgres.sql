...
insert into korisnik (ime, prezime, email,  password, grad, drzava, jmbg, adresa, telefon, datum_rodjenja, uloga, aktivan, aktiviran) values ('Marko', 'Markovic', 'marko.markovic@gmail.com', 'maki', 'Novi Sad', 'Srbija', '145874126547', 'Markovljeva 8', 64152677, '1989-6-16', 0, TRUE, TRUE);
insert into korisnik (ime, prezime, email,  password, grad, drzava, jmbg, adresa, telefon, datum_rodjenja, uloga, aktivan, aktiviran) values ('Adam', 'Adminic', 'adam.adminic@gmail.com', 'adam', 'Novi Sad', 'Srbija', '4152887563945', 'Adamoviceva 7', 415263254, '1990-7-16', 1, TRUE, TRUE);
